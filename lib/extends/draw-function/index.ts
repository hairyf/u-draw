...
/** 绘制换行字体原型方法 */
export const fillWarpText: DrawPosterUseCtxOpts = {
  name: 'fillWarpText',
  handle: (
    canvas: Canvas | undefined,
    ctx: DrawPosterCanvasCtx,
...
/** 绘制圆角矩形原型方法 */
export const roundRect: DrawPosterUseCtxOpts = {
  name: 'roundRect',
  handle: (
    canvas: Canvas | undefined,
    ctx: DrawPosterCanvasCtx,
...
/** 绘制填充圆角矩形方法 */
export const fillRoundRect: DrawPosterUseCtxOpts = {
  name: 'fillRoundRect',
  handle: (
    canvas: Canvas | undefined,
    ctx: DrawPosterCanvasCtx,
...
/** 绘制填充圆角矩形方法 */
export const strokeRoundRect: DrawPosterUseCtxOpts = {
...
/** 绘制圆角图片原型方法 */
export const drawRoundImage: DrawPosterUseCtxOpts = {
  name: 'drawRoundImage',
  handle: async (
    canvas: Canvas | undefined,
    ctx: DrawPosterCanvasCtx,
