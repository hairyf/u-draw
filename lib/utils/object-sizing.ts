...
export function calculateConcreteRect(style: {
  ...
  let xRelativeOrigin = { left: 0, center: .5, right: 1 }[style.intrinsicPosition?.[0] || "center"]
  let yRelativeOrigin = { top: 0, center: .5, bottom: 1 }[style.intrinsicPosition?.[1] || "center"]
